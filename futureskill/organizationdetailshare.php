...
mail($to,'NASSCOM FutureSkills : Request for more Details',$messages,$headers);
...
mail($to1,'NASSCOM FutureSkills : Request for more Details',$messages1,$header); 
echo "<span  style='color:green;' >Thank You For Registration</span>";


define('LOG_FILE','howcanjoin.txt');
$f = @fopen(LOG_FILE, 'a+');
if ($f) {
  @fputs($f, $semail.",");
  @fclose($f);
