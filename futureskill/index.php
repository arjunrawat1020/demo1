        ...
        <li>
            ...
            <div class="wrapper">
                <div class="banner-content">
                    ...
                    <p>Soon your employability will be as good as the skills you possess. But what are these skills and how can you keep pace? <br><br>NASSCOM FutureSkills aims to reskill 2 million professionals and potential employees & students in the IT/ITeS industry over a period of 5 years.</p>
                ...
                <div class="register-demo">
                    ...
                    <div class="form">
                        <form  method="post" id="democontact">
                            ...
                            <div class="fields">
                                <input type="email" placeholder="Email Id" id="email" required oninvalid="this.setCustomValidity('Please enter valid email')" onchange="this.setCustomValidity('')">
                            </div>
