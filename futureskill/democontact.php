...
mail($to,'NASSCOM FutureSkills : Demo Trial Request',$messages,$headers);
...
mail($to1,'NASSCOM FutureSkills : Demo Trial Request',$messages1,$header); 
echo "<span  style='color:green;' >Thank You For Subscribing</span>";


define('LOG_FILE','democontact.txt');
$f = @fopen(LOG_FILE, 'a+');
if ($f) {
  @fputs($f, $semail.",");
  @fclose($f);
