...
mail($to,'NASSCOM FutureSkills : How can I join',$messages,$headers);
...
mail($to1,'NASSCOM FutureSkills : How can I join',$messages1,$header); 
echo "<span  style='color:green;' >Thank you for your interest</span>";
